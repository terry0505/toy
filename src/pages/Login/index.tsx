  ...
  return (
    <div className={styles.login}>
        <ul className={styles.tab_base}>
            <li onClick={handleTab('/login/social')}>
                social 인증
            </li>
            <li onClick={handleTab('/login/general')}>
                일반 인증
            </li>
        </ul>
        { id == 'social' && (
            <div className={styles.panel_base}>
                <div className={styles.btn_wrap}>
                    <button className={styles.google_btn} onClick={handleSocialLogin('google')}>구글 로그인/회원가입</button>
                    <button className={styles.github_btn} onClick={handleSocialLogin('github')}>깃헙 로그인/회원가입</button>
                    <button className={styles.facebook_btn} onClick={handleSocialLogin('facebook')}>페이스북 로그인/회원가입</button>
                </div>
            </div>
        )}
        {id == 'general' && (
